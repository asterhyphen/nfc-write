...
class AutomationAction with _$AutomationAction {
  ...
  const factory AutomationAction.showNotification({required String title, required String body}) = ShowNotificationAction;
  const factory AutomationAction.launchApp({required String packageName}) = LaunchAppAction;
  const factory AutomationAction.setBrightness({required double level}) = SetBrightnessAction;
...
class AutomationProfile with _$AutomationProfile {
  ...
  factory AutomationProfile.fromJson(Map<String, dynamic> json) => _$AutomationProfileFromJson(json);
}
